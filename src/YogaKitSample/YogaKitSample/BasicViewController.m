...
//    child1.yoga.position = YGPositionTypeRelative;
    ...
    child1.yoga.height = YGPointValue(30);
    child1.yoga.flexGrow = 1;
    child1.yoga.flexShrink = 1;
    child1.yoga.flexBasis = YGValueAuto;
...
//    child2.yoga.position = YGPositionTypeRelative;
    ...
    child2.yoga.height = YGPointValue(30);
...
//    child3.yoga.position = YGPositionTypeRelative;
    child3.yoga.width = YGPointValue(100);
    child3.yoga.height = YGPointValue(30);
    child3.yoga.flexGrow = 1;
//    child3.frame = (CGRect) {
//        .origin = {
//            .x = 0,
//            .y = 0
